...
class NotiMaker:
    ...
    def addCategoryNotiToHtml(notiList, htmlBase):
        ...
        def addCategoryToHtmlListTag(category, htmlBase):
            ...
            NotiMaker.setTagAttribute("font-size:22px", "style", headerTag)
            NotiMaker.setTagAttribute("font-size:15px", "style", listTag)
            NotiMaker.setTagAttribute("padding-left:15px", "style", listTag)  # li 태그의 들여쓰기 없애기
    ...
    def addInfoTag(infoTagToAdd, html):
        ...
        NotiMaker.setTagAttribute("font-size:13px", "style", infoTag)
